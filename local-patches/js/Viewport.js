...
var viewHelper = new ViewHelper( camera, container );
	...
	function updateAspectRatio() {
		...
		camera.width = container.dom.offsetWidth;
		camera.height = container.dom.offsetHeight;
	...
	signals.editorCleared.add( function () {
	    ...
	    var unity = new THREE.Vector3 (0, 1, 0);
     	    camera.up.copy ( unity.applyQuaternion ( camera.quaternion ) );
	...
	signals.geometryUpdated.add( render );
